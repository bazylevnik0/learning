...
realize (GtkGLArea *area)
{
  ...
  const char *vertex_shader_string = "#version 330 core\n"
    ...
    "void main()\n"
    "{\n"
    "   gl_Position = vec4(aPos.x, aPos.y+uniShift, aPos.z, 1.0);\n"
    "}\0";
  const char *fragment_shader_string = "#version 330 core\n"
   ...
   // Change uniform in vertex shader
   int uniShift = glGetUniformLocation(programID, "uniShift");
   glUniform1f(uniShift,0.25);
